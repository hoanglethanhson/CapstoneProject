...
export class RoomAmenitiesRepository extends Repository<RoomAmenities> {
  ...
  async getAmenitiesDetailNotInRoomGroup(roomGroupId: any) {
    return await this.manager.query("SELECT amenities.amenities_id, amenities.icon_id, amenities.unusable_name as \'amenities_name\' FROM amenities where amenities.amenities_id\n" +
