...
CREATE TABLE `amenities` (
  ...
  `usable_name` varchar(255) NOT NULL COMMENT 'Name of amenities when usable',
  ...
  `icon_url` text COMMENT 'URL to amenities icon image',
...
CREATE TABLE `building` (
  ...
  `province` varchar(255) NOT NULL COMMENT 'Province of the building',
...
CREATE TABLE `building_type` (
  ...
  `building_type` varchar(1000) NOT NULL COMMENT 'Name of the type',
  `created_at` timestamp(6) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'Record create time ',
  `updated_at` timestamp(6) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'Record update time',
...
CREATE TABLE `service` (
  ...
  `icon_url` text COMMENT 'URL to the icon image of the service',
  `created_at` timestamp(6) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'Record create time',
  `updated_at` timestamp(6) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(6) COMMENT 'Record update time',
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (1, 'Son', 'Hoang', '1234', NULL, 'aa', b'1', 'bb', 'gg', 'email@gmail.com', 'image', 'Hoa Lac', b'1', b'1', b'1', '2019-10-08 21:13:14.783465', '2019-10-08 21:13:14.783465');
INSERT INTO `user` VALUES (2, 'Phong', 'Tran', '111', NULL, 'bb', b'1', 'phongfb', 'phonggg', 'phongemail@gmail.com', 'image', 'Hanoi', b'1', b'1', b'1', '2019-10-08 21:13:23.819680', '2019-10-08 21:13:23.819680');
COMMIT;
