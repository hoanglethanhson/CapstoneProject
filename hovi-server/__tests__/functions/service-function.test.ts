...
describe('Test function service', () => {
    ...
    /*it('Test create service with authentication', () => {
        return request
            .post('/service')
            .send({iconId: 3, name: 'test create', description: 'test create service'})
    ...
    it('Test update service setting with authentication', () => {
        return request
            .put('/service/1')
    ...
    it('Test update service setting without authentication', () => {
        return request
            .put('/service/1')
            .send({iconId: 3, name: 'test update service', description: 'test update service'})
            .set('Accept', 'application/json')
